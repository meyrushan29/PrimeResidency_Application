...
const FoodForm = () => {
  ...
  const validateForm = () => {
    ...
    const { ownerId, name, email, phoneNumber, foodType, numberOfPeople, date, time } = formData;
    ...
    if (!foodType) validationErrors.foodType = 'Food type is required';

    if (numberOfPeople < 1 || numberOfPeople > 50) {
      validationErrors.numberOfPeople = 'Choose 1 to 50 people';
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 to-white p-10">
      <div className="relative max-w-lg mx-auto bg-white p-8 rounded-xl shadow-xl border border-gray-300">
        ...
        <button
          ...
          className="absolute top-4 left-4 p-2 bg-green-500 text-white rounded-full hover:bg-green-600 transition duration-300 shadow-lg transform hover:scale-110 focus:outline-none"
        >
          &#8592;
        </button>

        <h1 className="text-3xl font-semibold text-green-700 mb-6 text-center">🍽️ Food Service Request</h1>
        ...
        {isSubmitted ? (
          <div className="text-center text-green-600">
            ...
            <button
              onClick={() => navigate('/ownerservices')}
              className="mt-6 px-6 py-3 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition duration-300 shadow-md focus:outline-none focus:ring-2 focus:ring-green-400"
            >
              More Services
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="ownerId" className="block text-sm font-medium text-gray-700">Owner ID (e.g., Ow1234)</label>
              <input
                type="text"
                id="ownerId"
                name="ownerId"
            ...
            <div className="mb-4">
              ...
              {errors.foodType && <p className="text-red-600 text-sm">{errors.foodType}</p>}
            </div>
            ...
            <div className="mb-4">
              ...
              {errors.numberOfPeople && <p className="text-red-600 text-sm">{errors.numberOfPeople}</p>}
            </div>
            ...
            <p className="text-orange-600 text-sm mt-2">
              You can not order food, and our workers will come to your place to cook it for you!
            </p>

            <button
              type="submit"
              className="w-full py-3 bg-green-500 text-white text-lg font-medium rounded-lg hover:bg-green-600 transition duration-300 focus:outline-none focus:ring-4 focus:ring-green-300"
            >
