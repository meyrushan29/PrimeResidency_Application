    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 to-white p-10">
      <div className="relative max-w-lg mx-auto bg-white p-8 rounded-xl shadow-xl border border-gray-300">
        ...
        <h1 className="text-3xl font-semibold text-green-800 mb-6 text-center">
          🍽️ Food Service Request
          <p className="text-orange-600 text-sm mt-2">
            You can not order food, and our workers will come to cook it for you in person!
          </p>
        </h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="mt-1 p-3 w-full border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-300"
              />
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={formData.name}
                onChange={handleChange}
                className="mt-1 p-3 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            ...
            <div className="mb-4">
              <label htmlFor="additionalNotes" className="block text-sm font-medium text-gray-700">
                Additional Notes
                <p className="text-orange-600 text-sm mt-2">
                  Explain which type of food do you prefer!
                </p>
              </label>
              <textarea
                id="additionalNotes"
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition duration-300"
            >
