...
const Navbar = () => {
    ...
    const token = true; 
    const userData = { image: profile_pic, name: "John Doe" }; 
        ...
        <nav className={`fixed w-full z-50 transition-all duration-500 ${
                ...
                <ul className="hidden md:flex items-center gap-8 font-medium">
                    {navLinks.map((link) => (
                        <NavLink 
                            ...
                            to={link.path}
                            className={({ isActive }) => 
                                `relative px-2 py-2 transition-all ${
                                    scrolled 
                        ...
                        <div className="relative group">
                            <div className={`flex items-center gap-3 cursor-pointer p-2 rounded-full ${
                                ...
                                <img 
                                    ...
                                    alt={userData.name} 
                                />
                                <span className={`hidden md:block text-sm font-medium ${scrolled ? 'text-gray-700' : 'text-white'}`}>
                                    {userData.name}
                                </span>
                                <svg 
            ...
            {showMenu && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 md:hidden" onClick={() => setShowMenu(false)}>
                    <div 
                        className="mobile-menu-container absolute right-0 top-0 bottom-0 w-72 sm:w-80 bg-white shadow-xl transform transition-all duration-500 animate-slide-in"
                    ...
                    >
                        ...
                        {token && userData && (
                            <div className="p-5 border-b flex items-center gap-4">
                                <img 
                                    className="w-12 h-12 rounded-full object-cover border-2 border-indigo-100 shadow-md" 
                                    src={userData.image} 
                                    alt={userData.name} 
                                />
                                <div>
                                ...
                                <div className="mt-6 border-t pt-4">
                                    <div className="px-4 space-y-2">
                                        <button 
                                            ...
                                            className="flex items-center gap-3 w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 rounded-xl transition-colors"
                                        >
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <button 
                                            ...
                                            className="flex items-center gap-2 w-full text-left px-4 py-3 text-sm text-red-600 hover:bg-red-50 rounded-lg"
                                        >
