...
const Footer = () => {
  return (
    <div className=' bg-gray-50'>
        <hr />
        <div className='bg-gray-50 flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10  mt-2 text-sm'>
            {/*----- Left------*/}
            <div>
                <img className='mb-5 w-40' src={logo} alt="PrimeResidency Logo" />
                <p className='w-full md:w-2/3 text-black leading-6'>
            ...
            {/*----- Center------*/}
            <div>
                <p className='text-xl text-black font-medium mb-5'>COMPANY</p>
            ...
            {/*----- Right------*/}
            <div>
                <p className='text-xl text-black font-medium mb-5'>GET IN TOUCH</p>
                <ul className='flex flex-col gap-2 text-black'>
        ...
        <div>
            ...
            <p className='py-5 text-gray-900 text-sm text-center'>
